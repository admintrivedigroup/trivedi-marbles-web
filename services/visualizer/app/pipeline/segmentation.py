...
Requires: torch, torchvision (Sam2ImageProcessorFast needs it), transformers>=4.56
(Sam2Model/Sam2Processor were added in transformers 4.56.0), a CUDA GPU for
interactive latency (see README.md "GPU/CPU implications").
"""
